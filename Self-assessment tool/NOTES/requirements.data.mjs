  ...
  },
  {
    ...
    reqs: [
      { id: 'Q6', state: 'built', text: 'A question belongs to its own domain and to any number of named categories. All nine categories TBS named are declared.',
        note: 'Business, Data, Application, Technology, Security, Privacy, Financial, Accessibility and Official Languages, asked for by Dan on 8 September. The shape was already there: a topics array on each question, and 44 of 176 now carry more than one. The four domain categories are mechanical, and security, privacy and financial are derived from the question wording and marked provisional. Accessibility and Official Languages are declared and carry nothing: a sweep of all 176 questions found official languages in two and accessibility in three, always in another sense, so they stay empty and the results page names the gap. What fills them is one Topics column in each domain sheet, comma separated, filled only on the rows that need more than their own domain.' },
