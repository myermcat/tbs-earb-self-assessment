...
export const sections = [
  ...
  },
  {
    ...
    reqs: [
      ...
      { id: 'H4', state: 'proposed', text: 'For the prototype: a database with sign-in, in a Canadian region, with rules that let somebody read and write their own records and nothing else.',
        note: 'Cloud Firestore in Montreal is the concrete version. A key-value store behind a small program of our own is the alternative, and it has no Canadian region.' },
  ...
  },
  {
    ...
    reqs: [
      ...
      { id: 'X6', state: 'agreed', text: 'Nothing is ever hard-deleted.' },
      { id: 'X7', state: 'open', owner: 'us', text: 'French.',
