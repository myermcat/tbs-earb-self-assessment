  ...
  },
  {
    ...
    reqs: [
      ...
      { id: 'Q10', state: 'open', owner: 'Dan', text: 'The category assignments themselves.',
        note: 'The mechanism is finished and waiting. Security, privacy and financial are currently derived from the wording of the question and are ours, not his. Accessibility and Official Languages are declared and empty, because a sweep of all 176 questions found official languages in two and accessibility in three, always in another sense: the FAIR principles\u2019 Accessible, and programming languages. Three hits is a gap in the instrument and not a category, so they stay empty and the results page names the gap rather than hiding it behind a number.' },
