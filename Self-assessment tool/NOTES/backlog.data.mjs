...
export const quick = {
  ...
  items: [
    ...
    { t: 'The cat had horns', status: 'done',
      why: 'The head outline peaked at both sides, which were the ears, and two more thin triangles were drawn floating above them. The head is a circle now and the ear bases sit inside it.' },
