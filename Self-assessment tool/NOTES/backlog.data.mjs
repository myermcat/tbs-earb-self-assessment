...
export const quick = {
  ...
  items: [
    ...
    { t: 'Six steps in a browser, and the store is live', status: 'next',
      why: 'This is the next step and it is yours: console.firebase.google.com, add a project, create Firestore in northamerica-northeast1, turn on Google and Microsoft sign-in, paste deploy/firestore.rules, register a web app, and send me the config block. I wire the client and publish. Everything on our side is written.' },
...
export const layers = [
  {
    ...
    groups: [
      ...
      { t: 'Firebase project, once it exists', status: 'next',
        why: 'The prototype store: a Firestore database in Montreal, sign-in, and the rules in deploy/firestore.rules. Free plan, no card.',
        subs: [
