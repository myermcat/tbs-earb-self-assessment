...
export const quick = {
  ...
  items: [
    ...
    { t: 'One click left on the store: the Google consent screen', status: 'next',
      why: 'Everything else is done and live. Open the assessor view, press Continue with Google, choose your account, and press Continue on the consent screen. That grant is yours to give, not mine, which is why I stopped there. It asks for your email address and nothing else, and it can be taken back at myaccount.google.com under Data and privacy.' },
